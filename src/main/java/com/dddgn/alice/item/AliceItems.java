...
public final class AliceItems {
    ...
    /** 阶段 3-B / S1（D-204）**机器配方只读探针**：按类型列出"读不懂"的配方样例（零写入）。 */
    public static final RegistryObject<Item> MACHINE_PROBE =
            ITEMS.register("machine_probe", () -> new MachineProbeItem(new Item.Properties()));
