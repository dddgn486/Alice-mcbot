...
public final class MiningPlanner {
    ...
    public Result plan(ServerPlayer bot, BlockPos target) {
        ...
        if (StandingPointSelector.isCurrentPositionGoodEnough(
            ...
            SurfacePathfinder.Result path = SurfacePathfinder.find(bot, startFoot, startFoot);
        ...
        SurfacePathfinder.Result path = SurfacePathfinder.find(bot, startFoot, standingFoot);
