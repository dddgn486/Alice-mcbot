...
tellraw @s [{"text":"[Alice 伐木 Job 场景·真树] ","color":"gold"},{"text":"4 棵同型橡树(20,64,208 / 19,64,213 / 29,64,213 / 33,64,208) + 云杉(28,64,208) + 2x2 高大云杉(22,64,218)。配额=场景可行树数（启动时推导，不再写死）。","color":"white"}]
