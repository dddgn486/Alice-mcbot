...
execute as @a[tag=alice_tr_running] run tellraw @a [{"text":"[TRACE] "},{"selector":"@s"},{"text":" t="},{"score":{"name":"@s","objective":"alice_tr_t"}},{"text":" x="},{"score":{"name":"@s","objective":"alice_tr_x"}},{"text":" y="},{"score":{"name":"@s","objective":"alice_tr_y"}},{"text":" z="},{"score":{"name":"@s","objective":"alice_tr_z"}},{"text":" vx="},{"score":{"name":"@s","objective":"alice_tr_vx"}},{"text":" vy="},{"score":{"name":"@s","objective":"alice_tr_vy"}},{"text":" vz="},{"score":{"name":"@s","objective":"alice_tr_vz"}},{"text":" og="},{"score":{"name":"@s","objective":"alice_tr_og"}},{"text":" yaw="},{"score":{"name":"@s","objective":"alice_tr_yaw"}}]
execute as @a[tag=alice_tr_running] run scoreboard players remove @s alice_tr_budget 1
execute as @a[tag=alice_tr_running, scores={alice_tr_budget=..0}] run function alice_test:trace_stop
execute as @a[tag=alice_tr_running] at @s if entity @e[type=minecraft:marker,distance=..0.8] run function alice_test:trace_stop
