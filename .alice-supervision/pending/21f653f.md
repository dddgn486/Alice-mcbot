...
- Commit: `21f653f1c1255e74b9d520b92918b0beae933b84`
- Subject: docs(supervision): physics-chain mechanism evidence for bot tick no-collision (read-only, no root-cause)
- Authored: 2026-08-25T17:15:19+08:00
...
```text
.alice-supervision/research/physics-chain-mechanism-evidence-20260825.md
```

## Commit summary

```text
 .../physics-chain-mechanism-evidence-20260825.md   | 90 ++++++++++++++++++++++
