...
- Commit: `f33292c84a48008cf0c8ceafb786231c95b4f0fb`
- Subject: fix: sync bot inventory after destination transfer leg
- Authored: 2026-08-23T14:36:16+08:00
...
```text
 docs/HANDOVER.md                                                      | 3 ++-
 src/main/java/com/dddgn/alice/transfer/ChestBotTransferPrimitive.java | 1 +
...
index 60a343e..2c09bc6 100644
--- a/docs/HANDOVER.md
+++ b/docs/HANDOVER.md
@@ -71,8 +71,9 @@ GitHub：`github` 远端 `dddgn486/Alice-mcbot`（本会话未推 GitHub，push
