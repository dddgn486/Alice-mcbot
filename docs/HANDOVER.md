...
> 见 `docs/TESTING_GUIDE.md` **§2.5**。已装工件 `alice-1.0.0-1.20.1.jar`
> sha256=`590e5cf222e41fdf799b171da6947123f0fe680ba8d3400ab719e0576f3ac8da`（同步于 2026-09-18 12:54）。
> 离线侧已绿：`module:protection` **57/57** · CORE **49/49**（步序 diff=0） · `check-all.sh` **16 PASS + 1 预期 WARN**。
