...
- **本断点已同步的 jar**：`cd9dab70db40a248cd30885edd89dc2f90b194b7f4a52aae947e8772d5382b87`（源 = `build/libs`，2026-09-15 22:4x 同步到客户端 `mods/`；**含 S-5/D-226 + §5.9/D-227 + D-228 + D-229 + D-230 开关 + M4b/D-231 + M3b/D-232 + D-233 提档**）
