...
- **本断点已同步的 jar**：`8b966e9c759bd392221afceaf4c227fbd5339327165e52d8e6558c8db5af4fdf`（2026-09-17；**含 D-226…D-277 + 队列①②③④⑤⑦ + S-6/S-9(观测+消费) + F1/F2/F3/F4 + 死亡第 1 步**，客户端与 Windows 仓库同哈希；门禁 **15 PASS + 1 预期 WARN**；CORE **43 步** / FULL 51 项）
