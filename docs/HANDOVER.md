...
- **本断点已同步的 jar**：`30ff9b8712f9525945d3e383209dd059b8370a2e0b9b58a8837e42a5951c7fb6`（源 = `build/libs`，2026-09-15 23:1x 同步到客户端 `mods/`；**含 D-226/227/228/229/230 + D-231/232 + D-233 + D-234（四 Job 统一 lastFailure 口径）**）
