...
**等级**：IMPLEMENTED + COMPILES + 资源自检 PASS（77 项）+ 已同步（jar `ff5a74b2…`）；**待客户端**（一次右键）。
...
**等级**：IMPLEMENTED + COMPILES + 资源自检 PASS + 已同步（jar `ff5a74b2…`）；**待客户端**（一次右键）。
...
**等级**：IMPLEMENTED + COMPILES + 资源自检 PASS + 已同步（jar `ff5a74b2…`）；**待客户端**（一次右键 `alice:machine_probe`）。
...
**等级**：IMPLEMENTED + COMPILES + 资源自检 PASS（76 项，探针物品已回收）+ 已同步（jar `ff5a74b2…`）；
...
**等级**：IMPLEMENTED + COMPILES + 已同步（jar `ff5a74b2…`）；**待客户端**：CORE 期望回到 `(26/26) → PASS`。
...
**等级**：IMPLEMENTED + COMPILES + 已同步（jar `ff5a74b2…`）；**待客户端**：CORE 期望 `(26/26) → PASS`。
...
**等级**：IMPLEMENTED + COMPILES + 已同步（jar `ff5a74b2…`）；**待客户端**（再点一次 probe 验证"传送+复位"生效）。
