...
| 0.2 | `P4′` 裁定（`D-429` §五） | 决定最坏 tick 怎么压 | ①`P4″`＝给重消费者 `SearchBudget` 加时间上限（**推荐**，1 轮 + CORE diff）②维持 400（0）③收紧到 60（1 轮 + CORE diff） | 0–1 轮 | 用户 |
